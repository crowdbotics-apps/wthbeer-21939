"""wthbeer_21939 URL Configuration
...
admin.site.site_header = "WthBeer"
admin.site.site_title = "WthBeer Admin Portal"
admin.site.index_title = "WthBeer Admin"

# swagger
api_info = openapi.Info(
    title="WthBeer API",
    default_version="v1",
    description="API documentation for WthBeer App",
)
